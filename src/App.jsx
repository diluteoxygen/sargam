                ...
                {target?.links && (target.links.spotify || target.links.apple || target.links.youtube) && (
                  <div className="sg-result-links">
                    {target.links.spotify && (
                      <a href={target.links.spotify} target="_blank" rel="noreferrer" className="sg-result-link brand-spotify" title="Listen on Spotify">
                    ...
                    {target.links.apple && (
                      <a href={target.links.apple} target="_blank" rel="noreferrer" className="sg-result-link brand-apple" title="Listen on Apple Music">
                    ...
                    {target.links.youtube && (
                      <a href={target.links.youtube} target="_blank" rel="noreferrer" className="sg-result-link brand-youtube" title="Watch on YouTube">
